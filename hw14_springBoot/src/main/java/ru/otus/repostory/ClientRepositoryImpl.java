...
public class ClientRepositoryImpl implements ClientRepository {
    ...
    public ClientRepositoryImpl(ClientIdGenerator idGenerator) {
        ...
        clients.add(new Client(idGenerator.generateId(), "Крис Гир"
                , new Address(idGenerator.generateId(), "address1")
                , List.of(new Phone(1L,"12345657689"),new Phone(2L,"8-800-9999")))
        );
        clients.add(new Client(idGenerator.generateId(), "Десмин Боргес"
                , new Address(idGenerator.generateId(), "address2")
                , List.of(new Phone(3L,"987321654"),new Phone(4L,"8-800-22222")))
        );
